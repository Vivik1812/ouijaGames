...
const CreateUser = () => {
  ...
  const Login = [
      ...
      inputs: [
        {
          ...
          autoComplete: "off",
          className:
            "w-full border-b-2 bg-transparent text-lg duration-300 focus-within:border-indigo-500 mb-4",
        },
        {
          type: "email",
        ...
        },
        {
          ...
          className:
            "w-full border-b-2 bg-transparent text-lg duration-300 focus-within:border-indigo-500",
        },
      ],
      className: "space-y-8",
    },
    {
      ...
      text: "Crear usuario",
      className:
        "transform w-full mt-4 mb-4 rounded-sm bg-indigo-600 py-2 font-bold duration-300 hover:bg-indigo-400",
    },
    {
      type: "text",
      text: [
